...
function Projects() {
  ...
  return (
    <div>
      ...
      <section style={{width:'100%',display:'flex',flexDirection:'column',alignItems:'center',marginTop:'7rem'}}>
      ...
      <h1 style={{margin:'0',fontWeight:'lighter',color:'#0E8B8F',textAlign:'center'}}>Launched Projects</h1>
      <div style={{ background: '#0E8B8F', width: '3rem', height: '1px',marginTop:'5px' }}></div>
        <div style={{display:'grid',width:'100%',gridTemplateColumns:'auto auto auto',placeItems:'center',placeContent:'center',columnGap:'3rem',marginTop:"2rem"}}>
      <div className='card' >
        <img  src={image} alt="" />

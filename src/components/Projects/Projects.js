...
function Projects() {
  ...
  const arr = [1, 2, 3, 4]
  return (
    <div style={{ width: '100%', overflowX: "hidden" }} className='projectSectionMain'>
      <Header></Header>
      ...
      <section style={{ width: '100%', marginTop: '5rem', marginBottom: '5rem', display: 'flex', flexDirection: 'column', alignItems: 'center', }}>
        <h1 style={{ margin: '0', fontWeight: 'lighter', color: '#0E8B8F', textAlign: 'center' }}>EBD Design House</h1>
        <div style={{ background: '#0E8B8F', width: '3rem', height: '1px', marginTop: '5px', marginBottom: '2rem' }}></div>

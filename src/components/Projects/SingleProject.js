...
function SingleProject() {
    return (
        <div>
            ...
            <section style={{ display: 'flex',alignItems:'center',justifyContent:'center',marginTop:'2%',flexDirection:'column'}}>
            ...
            <section style={{display:'flex',alignItems:'center',justifyContent:'center'}}>
                <div className='detailsSection'>
                    <div style={{width:'22%',marginRight:'3%'}}>
                        <span style={{border:'solid 1px #0E8B8F',color:'#0E8B8F',padding:'3px',width:'fit-content'}}>PROJECT DETAILS</span>
                        <span>Bedrooms</span>
                        <span>Bathrooms</span>
                        <span>Construction Status</span>
                        <span>Super Builtup area (ft<sup>2</sup>)</span>
                        <span>Carpet Area (ft<sup>2</sup>)</span> 
                        <span>Total Floors</span> 
                        <span>Car Parking</span>
                        <span>Project Name</span>
                    </div>
                    <div className='colmn-2' style={{width:'35%'}}>
                        <span></span><br />
                        <span>3</span> 
                        <span>3</span>
                        <span>Under Construction</span>
                        <span style={{marginTop:'3px'}}>1510</span>
                        <span style={{marginTop:'2px'}}>1300</span>
                        <span>2</span>
                        <span>1</span>
                        <span>Aspenglow Villa Project</span>
                    </div>
                    <div style={{width:'35%',borderLeft:'2px solid #9b9999',alignSelf:'flex-end',paddingLeft:'30px'}}>
                        <span style={{color:'#0E8B8F'}}>3 BHK NSD Grance Villa Project</span> 
                        <span>12 cent area</span>
                        <span style={{color:'#0E8B8F'}}>1510 sqft</span>
                        <span style={{marginTop:'3px'}}>Full time security</span>
                        <span style={{marginTop:'2px',color:'#0E8B8F'}}>Community living</span>
                        <span>Club House</span>
                        <span style={{color:'#0E8B8F'}}>Badminton court</span>
                        <span>Mini lawn party area</span>
                    </div>
                </div>
            </section>
